...
est_avg_ft_c<- pe_c |> 
  ggplot(aes(x = `1`)) +
    geom_histogram(aes(y = after_stat(count/sum(count))),bins = 100, fill = "red", color = "blue") + geom_vline(xintercept = median(pe_c$`1`), linetype = "dotted", lwd = 1.5) +
    labs(title = "Posterior Estimated Predicition FT% for Centers",
...
est_avg_ft_pf<- pe_pf|> 
  ggplot(aes(x = `1`)) +
    geom_histogram(aes(y = after_stat(count/sum(count))),bins = 100, fill = "red", color = "blue") + geom_vline(xintercept = median(pe_pf$`1`), linetype = "dotted", lwd = 1.5)+
...
est_avg_ft_sf<- pe_sf |> 
  ggplot(aes(x = `1`)) +
    geom_histogram(aes(y = after_stat(count/sum(count))),bins = 100, fill = "red", color = "blue") + geom_vline(xintercept = median(pe_sf$`1`), linetype = "dotted", lwd = 1.5) +
...
est_avg_ft_sg<- pe_sg |> 
  ggplot(aes(x = `1`)) +
    geom_histogram(aes(y = after_stat(count/sum(count))),bins = 100, fill = "red", color = "blue") + geom_vline(xintercept = median(pe_sg$`1`), linetype = "dotted", lwd = 1.5)+
...
est_avg_ft_pg<- pe_pg |> 
  ggplot(aes(x = `1`)) +
    geom_histogram(aes(y = after_stat(count/sum(count))),bins = 100, fill = "red", color = "blue") + geom_vline(xintercept = median(pe_pg$`1`), linetype = "dotted", lwd = 1.5)+
